#!/system/xbin/bash
#AUTHOR:MR.Z1R0
#Github:https://github.com/MrZ1R0
...
echo "\033[32;1mTULIS= MR.Z1R0 TAMPANS "
read p;
...
|14.Admin Finder             |
|15.Root Hp                  |
|16.kumpulan deface Keren    |
|17.Hack Satelit             |
|18.Pelacak Penipu           |
|19.Hack CCTV                |
|20.pembuat panas Hp Orang   |
|21.Hack Fb target 100% work |
...
sleep 4
echo "Selamat Anda Mendapatkan LONTE"
sleep 4
echo "Gak Senang Lo Njenk"
sleep 4
echo "HACK FB GUA SANA ( Zhen ) tuh nama fb gua"
sleep 3
...
sleep 3
toilet -f standard -F gay "MAMPUS LO ORANG YANG SUKA NYA GRATISAN"
